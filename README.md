...
<mark>**Диаграмма с описанием доступна в папке file-and-metadata-upload. Эта реализация - учебный пример. Не делайте так в production-коде. Пример специально излишне усложнен, чтобы продемонстрировать состояние
